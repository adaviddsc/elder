...
$(function() {
  ...
  while(travel_title[i]!=null){
    if (i%2==0){
      if ( self_photo[travel_username[i]]!=undefined && self_name[travel_username[i]]!=undefined ){
        $('.travel-bodyLeft').append('<div class="travel-box '+travel_sick[i]+'" articleNumber="'+i+'"><div class="travel-boxImg"><img src="../readfile/readfile-travelPhoto.php?id='+travel_photo[travel_articleID[i]][0]+'" data-toggle="modal" data-target="#myModal-travelInfo"></div><div class="travel-boxBottom"><h1 class="travel-title">'+travel_title[i]+'</h1><div class="travel-selfInfo"><img src="../readfile/readfile-selfPhoto.php?id='+self_photo[travel_username[i]]+'&updateTime='+self_photo_update[travel_username[i]]+'"><h1 class="travel-selfName">'+self_name[travel_username[i]]+'</h1><i class="fa fa-map-marker findPosition"></i></div></div></div>');
      }
      else{
        $('.travel-bodyLeft').append('<div class="travel-box '+travel_sick[i]+'" articleNumber="'+i+'"><div class="travel-boxImg"><img src="../readfile/readfile-travelPhoto.php?id='+travel_photo[travel_articleID[i]][0]+'" data-toggle="modal" data-target="#myModal-travelInfo"></div><div class="travel-boxBottom"><h1 class="travel-title">'+travel_title[i]+'</h1><div class="travel-selfInfo"><img src="../images/user_icon.png"><h1 class="travel-selfName">新使用者</h1><i class="fa fa-map-marker findPosition"></i></div></div></div>');

      }
    }
    if (i%2==1){
      if ( self_photo[travel_username[i]]!=undefined && self_name[travel_username[i]]!=undefined ){
        $('.travel-bodyRight').append('<div class="travel-box '+travel_sick[i]+'" articleNumber="'+i+'"><div class="travel-boxImg"><img src="../readfile/readfile-travelPhoto.php?id='+travel_photo[travel_articleID[i]][0]+'" data-toggle="modal" data-target="#myModal-travelInfo"></div><div class="travel-boxBottom"><h1 class="travel-title">'+travel_title[i]+'</h1><div class="travel-selfInfo"><img src="../readfile/readfile-selfPhoto.php?id='+self_photo[travel_username[i]]+'&updateTime='+self_photo_update[travel_username[i]]+'"><h1 class="travel-selfName">'+self_name[travel_username[i]]+'</h1><i class="fa fa-map-marker findPosition"></i></div></div></div>');
      }
      else{
        $('.travel-bodyRight').append('<div class="travel-box '+travel_sick[i]+'" articleNumber="'+i+'"><div class="travel-boxImg"><img src="../readfile/readfile-travelPhoto.php?id='+travel_photo[travel_articleID[i]][0]+'" data-toggle="modal" data-target="#myModal-travelInfo"></div><div class="travel-boxBottom"><h1 class="travel-title">'+travel_title[i]+'</h1><div class="travel-selfInfo"><img src="../images/user_icon.png"><h1 class="travel-selfName">新使用者</h1><i class="fa fa-map-marker findPosition"></i></div></div></div>');
      }
    }
    i++;
  }
  ...
  */
  ...
  $(".sick-avoid li").on("click", function(event) {
    $(".sick-avoid li").removeClass("active");
    $(this).addClass("active");
    $(".travel-box").fadeIn();
    $("."+$(this).attr('value')).hide();
  });
  $("#search-btn").on("click", function(event) {
    document.location.href="travel.php?search="+$("#search-input").val();
  });
