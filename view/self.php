...
<html>
	...
	<body>
		<div id="section">
			...
			<img src="../images/Tank.jpg" alt="Tank" style="width:304px;height:450px">
			<table style="width:100%">
				<tr>
					<th><b><font color="#FFFFFF" size="8">貴姓大名</font></b></th>
					<th><b><font color="#FFFFFF" size="8">123</font></b></th>		
				 </tr>
				 <tr>
					<td><b><font color="#FFFFFF" size="8">性別</font></b></td>
					<td><b><font color="#FFFFFF" size="8">123</font></b></td>		
				 </tr>
				 <tr>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form class="item-info-form" enctype="multipart/form-data" id="add-travelArti-form" action="../account/add-self.php" method="post">
		        	<div class="fa fa-camera-retro" id="add-selfPhoto"></div>
		        	...
		        	性別<input class="form-control" type="text">
		        	年齡<input class="form-control" type="text">
		        	興趣<input class="form-control" type="text">
		        	夢想<input class="form-control" type="text">
		        	感情狀態<input class="form-control" type="text">
		        	哪裡人<input class="form-control" type="text">
